...
#include <list>
#include "jugador.h"
#include "/home/coyote/googletest-master/googletest/include/gtest/gtest.h"
...
TEST(Jugador, setApuestasygetApuestas) {
  Jugador j("33XX", "1");
  std::string nomfich=j.getDNI()+".txt";
  std::ofstream salida(nomfich.c_str());
  salida << 1 << "," << "10" << "," << 15<< "\n";
  salida << 2 << "," << "rojo" << "," << 25<< "\n";
  salida << 3 << "," << "par" << "," << 35<< "\n";
  salida << 4 << "," << "bajo" << "," << 45<< "\n";
