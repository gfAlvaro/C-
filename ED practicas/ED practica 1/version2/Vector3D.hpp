...
// Para usar la clase vector de STL
#include <vector>
...
class Vector3D
{
  //! \name Atributos privados de la clase Vector3D
	...
	*/
	...
	//No es necesario un destructor como en la versión con array dinámico
